...
import { useCartStore } from "/Jahangir/codes/Vue/pinia-courses/src/stores/CartStore";
      ...
      <div v-if="!cartStore.isEmpty">
        <ul class="items-in-cart">
          <CartItem
            ...
            :product="items[0]"
            :count="items.length"
            @updateCount="cartStore.setCounter(items[0], $event)"
            @clear="cartStore.clearItam(name)"
          />
        </ul>
